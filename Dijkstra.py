...
print("This code will implement Djikstra Algorithm for a Point Robot")
...
# Here Dimension and Clearance will be both 0
dimension = 0
clearance = 0
...
if start_cords_y > 150 or goal_cords_y > 150:
